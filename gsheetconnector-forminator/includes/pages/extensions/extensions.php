...
<div class="wrap">
    <div class="extensions-list">
                    ...
                    if (!is_plugin_active($details['pro_plugin_active'])) {
                        if ($is_free_active || $is_pro_installed) {
                                ...
                                <div class="gsheetconnector-list-item">
                                    <div class="addon-item-header">
                                        ...
                                        <a href="<?php echo esc_url($details['buyLink']); ?>" target="_blank">
                                            <img src="<?php echo esc_url($details['img']); ?>"
                                                alt="<?php echo esc_attr($details['name']); ?>" loading="plugin-img">
                                        </a>
                                    ...
                                    <div class="addon-item-footer">
                                        <div class="button-bar">
                                            <button class="gs-ff-activate-plugin-btn button button-free proactive"
                                                data-plugin="<?php echo esc_attr($details['pro_plugin_active']); ?>">
                                                <?php esc_attr_e('Activate', 'gsheetconnector-forminator'); ?>
                                            </button>
                            ...
                            <?php } else { ?>
                                <div class="gsheetconnector-list-item">
                                    <div class="activated">
                                        <a href="#" class="button button-free gs-ff-deactivate-plugin"
                                    ...
                                    <div class="addon-item-header">
                                        ...
                                        <div class="addon-item-header-meta">
                                            ...
                                            <div class="addon-item-header-meta-excerpt">
                                                <a href="<?php echo esc_url($details['buyLink']); ?>" target="_blank" class="addon-link">
                                                    <?php esc_attr_e('Upgrade to PRO', 'gsheetconnector-forminator'); ?>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="gsheetconnector-list-item">
                            ...
                            <div class="addon-item-header">
                                ...
                                <div class="addon-item-header-meta">
                                    ...
                                    <div class="addon-item-header-meta-excerpt">
                                        <strong><?php esc_attr_e('Already using PRO version', 'gsheetconnector-forminator'); ?></strong>
                                    </div>
                                </div>
                            </div>
                            <div class="addon-item-footer">
                                ...
                                <div class="button-bar">
                                    <?php if ($is_free_active): ?>
                                        <button class="button button-secondary" disabled>
                                            <?php esc_attr_e('Activated', 'gsheetconnector-forminator'); ?>
                                        </button>
                                    <?php elseif ($is_free_installed && !$is_free_active): ?>
                                        <button class="gs-ff-activate-plugin-btn button button-free"
                                    ...
                                    <?php else: ?>
                                        <button class="gs-ff-install-plugin-btn button "
        ...
        <?php wp_nonce_field('frmntr-gs-ajax-nonce', 'frmntr-gs-ajax-nonce'); ?>
