 ...
 * to rate the "GSheetConnector for Forminator " plugin on WordPress.org.
 *
 * @return void
    ...
    <div class="gsfrm-free">
        ...
        <div class="gsc-admin-footer-bar">
            ...
            <div class="gsc-footer-left">
                ...
                <strong>
                    <?php echo esc_html__('GSheetConnector for Forminator Forms', 'gsheetconnector-forminator'); ?>
                </strong>

                <span class="gsc-stars">★★★★★</span>

                <?php echo esc_html__('on', 'gsheetconnector-forminator'); ?>

                <a href="https://wordpress.org/plugins/gsheetconnector-forminator/#reviews" target="_blank">
                    <?php echo esc_html__('WordPress.org', 'gsheetconnector-forminator'); ?>
                </a>

                <?php echo esc_html__('to help us spread the word.', 'gsheetconnector-forminator'); ?>
            </div>
            ...
            <div class="gsc-footer-right">
                ...
                <div class="gsc-footer-version">
                    <?php
                    echo esc_html__('Version:', 'gsheetconnector-forminator') . ' ' .
                        esc_html(GS_FORMNTR_VERSION);
                    ?>
                </div>
        ...
        <div class="assistant-widget gsgf-free">
            ...
            <div class="assistant-icon" id="assistantBtn">
                <img src="<?php echo esc_url(GS_FORMNTR_URL); ?>/assets/img/gsheet-logo.svg"
            ...
            <div class="assistant-menu" id="assistantMenu">
                ...
                <a href="https://www.gsheetconnector.com/docs/forminator-forms-gsheetconnector" target="_blank"
                    ...
                    </span> <?php echo esc_html__('Docs', 'gsheetconnector-forminator'); ?>
                </a>
                <a href="https://www.gsheetconnector.com/plugins" target="_blank"
                    ...
                    </span><?php echo esc_html__('Plugins', 'gsheetconnector-forminator'); ?>
                </a>
                <a href="https://wordpress.org/support/plugin/gsheetconnector-forminator/" target="_blank"
                    class="menu-item d-flex align-center gap-10 fw-500">
                    <span class="menu-icon">
                        <!-- Support Icon -->
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    </span> <?php echo esc_html__('Support', 'gsheetconnector-forminator'); ?>
                </a>
            </div>
